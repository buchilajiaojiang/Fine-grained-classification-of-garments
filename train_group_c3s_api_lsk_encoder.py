...
from models.model_group_c3s_api_lsk_encoder import Net, RegularLoss
...
if __name__ == "__main__":
    ...
    center = torch.zeros(13, 256).cuda()
    ...
    for epoch in range(0, configs["epoch"], 1):
        ...
        for batch_cnt, batch in enumerate(train_loader):
            ...
            # compute loss
            # logits = torch.cat([logit_all, logit2], dim=0)
            # targets = labels1.repeat(2)
