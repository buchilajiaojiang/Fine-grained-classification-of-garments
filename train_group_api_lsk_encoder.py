...
if __name__ == "__main__":
    ...
    configs = {
        "num_classes": 13, "img_size": 448, "lr": 1e-4, "epoch": 150, 
    ...
    lr, momentum, decay_step, weight_decay = configs["lr"], 0.9, 75, 0.0001
    ...
    scheduler = lr_scheduler.MultiStepLR(optimizer, milestones=[40,120,140], gamma=0.1, last_epoch=-1) # [5,80,120,140]
    ...
    center = torch.zeros(13, 2048).cuda()
    acc_best = {"acc": 0, "epoch": 0}
    
    writer = SummaryWriter(log_dir='./logs/test') # tensorboard --logdir=./logs
